...
if __name__ == "__main__":
    ...
    test_prompt = "A highly detailed macro photography shot of a glowing blue crystal in a dark cave, cinematic lighting, 8k resolution"
    generate_image(test_prompt, width=1024, height=1024)
